d3.csv("static/studyprograminformationisesoft.csv", function(data1) {
  ...
  svg.append("text").style("text-align", "center").text("Computer Engineering (Software)").attr("x", -40).style("font-size", "20px")
      .attr("y", 170);

  var data = { creditsLectures: data1.creditsLectures, creditsErgaenzungsbereich: data1.creditsErgaenzungsbereich, creditsInternship: data1.creditsInternship, creditsBachelorThesis: data1.creditsBachelorThesis }
  var sum = parseInt(data1.creditsLectures) + parseInt(data1.creditsErgaenzungsbereich) + parseInt(data1.creditsBachelorThesis) + parseInt(data1.creditsInternship)
