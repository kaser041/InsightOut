d3.csv("static/studyprograminformationisecomm.csv", function(data1) {
  ...
  var data = { creditsLectures: data1.creditsLectures, creditsErgaenzungsbereich: data1.creditsErgaenzungsbereich, creditsProjects: data1.creditsProjects, creditsInternship: data1.creditsInternship, creditsBachelorThesis: data1.creditsBachelorThesis }
  var sum = parseInt(data1.creditsLectures) + parseInt(data1.creditsErgaenzungsbereich) + parseInt(data1.creditsProjects) + parseInt(data1.creditsBachelorThesis) + parseInt(data1.creditsInternship)
