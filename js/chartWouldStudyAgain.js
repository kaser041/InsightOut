function generateWouldStudyAgainChart(checkBoxId) {
        ...
        case "komediaChx":
            if (checkbox.checked) {
                d3.csv("static/datakomedia.csv", function (data1) {
                    ...
                    var svg = d3.select("#chartWouldStudyAgainKomedia")
                        .append("svg")
                        .attr("width", width)
                        .attr("height", height)
                        .append("g")
                ...
                d3.select("#chartWouldStudyAgainKomedia").selectAll("svg").remove();
            }
            break;
        case "iseChx":
            if (checkbox.checked) {
                d3.csv("static/dataise.csv", function (data1) {
                    ...
                    // append the svg object to the div called 'my_dataviz'
                    var svg = d3.select("#chartWouldStudyAgainISE")
                        .append("svg")
                        .attr("width", width)
                        .attr("height", height)
                        .append("g")
                    ...
                    var data = { wouldStudyAgain_yes: data1.wouldStudyAgain_yes, Female: data1.wouldStudyAgain_no }
                    var sum = parseInt(data1.wouldStudyAgain_yes) + parseInt(data1.wouldStudyAgain_no)
                    // set the color scale
                    var color = d3.scaleOrdinal()
                        .domain(data)
                ...
                d3.select("#chartWouldStudyAgainISE").selectAll("svg").remove();
            }
            break;
        case "aiChx":
            if (checkbox.checked)
            {
                d3.csv("static/dataai.csv", function(data1) {
                    ...
                    // append the svg object to the div called 'my_dataviz'
                    var svg = d3.select("#chartWouldStudyAgainAI")
                        .append("svg")
                        .attr("width", width)
                        .attr("height", height)
                        .append("g")
                    ...
                    var data = { Male: data1.wouldStudyAgain_yes, Female: data1.wouldStudyAgain_no }
                    var sum = parseInt(data1.wouldStudyAgain_yes) + parseInt(data1.wouldStudyAgain_no)
                        // set the color scale
                    var color = d3.scaleOrdinal()
                        .domain(data)
                ...
                d3.select("#chartWouldStudyAgainAI").selectAll("svg").remove();
            }
            break;
