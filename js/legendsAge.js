...
// Handmade legend
svg.append("circle").attr("cx", 550).attr("cy", 50).attr("r", 6).style("fill", "#ff9173")
svg.append("circle").attr("cx", 500).attr("cy", 50).attr("r", 6).style("fill", "#00cadc")
svg.append("circle").attr("cx", 600).attr("cy", 50).attr("r", 6).style("fill", "#2ac69d")
svg.append("circle").attr("cx", 650).attr("cy", 50).attr("r", 6).style("fill", "#fff753")
